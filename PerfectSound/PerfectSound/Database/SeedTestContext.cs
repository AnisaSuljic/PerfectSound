...
{
    public partial class SeedTestContext : DbContext
    {
        public SeedTestContext()
        {
        }

        public SeedTestContext(DbContextOptions<SeedTestContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=SeedTest;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.HasIndex(e => e.SongAndPodcastId, "IX_Comment_SongAndPodcastID");
            ...
            modelBuilder.Entity<Person>(entity =>
            {
                ...
                entity.HasIndex(e => e.GenderId, "IX_Person_GenderID");
            ...
            modelBuilder.Entity<PodcastSeason>(entity =>
            {
                ...
                entity.HasIndex(e => e.SongAndPodcastId, "IX_PodcastSeason_SongAndPodcastID");
            ...
            modelBuilder.Entity<PodcastSeasonEpisode>(entity =>
            {
                ...
                entity.HasIndex(e => e.PodcastSeasonId, "IX_PodcastSeasonEpisode_PodcastSeasonID");
            ...
            modelBuilder.Entity<Quote>(entity =>
            {
                ...
                entity.HasIndex(e => e.SongAndPodcastId, "IX_Quote_SongAndPodcastID");
            ...
            modelBuilder.Entity<Rating>(entity =>
            {
                ...
                entity.HasIndex(e => e.SongAndPodcastId, "IX_Rating_SongAndPodcastID");
            ...
            modelBuilder.Entity<SongAndPodcast>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductionCompanyId, "IX_SongAndPodcast_ProductionCompanyID");
            ...
            modelBuilder.Entity<SongAndPodcastGenre>(entity =>
            {
                ...
                entity.HasIndex(e => e.GenreId, "IX_SongAndPodcastGenre_GenreID");

                entity.HasIndex(e => e.SongAndPodcastId, "IX_SongAndPodcastGenre_SongAndPodcastID");
            ...
            modelBuilder.Entity<SongAndPodcastPerson>(entity =>
            {
                ...
                entity.HasIndex(e => e.PersonId, "IX_SongAndPodcastPerson_PersonID");

                entity.HasIndex(e => e.RoleId, "IX_SongAndPodcastPerson_RoleID");

                entity.HasIndex(e => e.SongAndPodcastId, "IX_SongAndPodcastPerson_SongAndPodcastID");
