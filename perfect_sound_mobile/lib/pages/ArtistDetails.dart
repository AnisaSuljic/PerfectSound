...
class ArtistDetails extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  Row(
                    children: [
                      IconButton(
                        onPressed: () {
                          sort='up';
                          GetSongAndPodcastPerson(artists.personId, sort);
            ...
            ArtistSaPWidget(artists.personId),
          ],
        ),
      ),
    );
          ...
          children: [
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Gender : ' + artists.gender!.genderName.toString(),
                    style: TextStyle(fontSize: 16, color: Colors.black),),
                  Text('Birth place : ' + artists.placeOfBirth.toString(),
                    style: TextStyle(fontSize: 16, color: Colors.black),),
                ],
              ),
            ),
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(10.0),
                child: Container(
                    child:Text(artists.biography.toString(),
                        style: TextStyle(fontSize: 16, color: Colors.black))
                ),
              ),
              SizedBox(
  ...
  Widget ArtistSaPWidget(int? personId)
  {
    return FutureBuilder<List<SongAndPodcastPerson>>(
      future: GetSongAndPodcastPerson(personId,sort),
